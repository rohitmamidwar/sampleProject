...
import com.details.employee.domain.Job;
import com.details.employee.repository.JobRepository;
...
/**
 * REST controller for managing {@link com.details.employee.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
